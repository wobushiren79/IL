...
public class PreTypeEnumTools : DataTools
{
        ...
        PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        {
            case PreTypeEnum.HaveItems:
                preTypeData.preDescribe = string.Format(TextHandler.Instance.GetTextById(5021), itemsInfo.name, itemsNumber + "");
                break;
            case PreTypeEnum.PayItems:
                preTypeData.preDescribe = string.Format(TextHandler.Instance.GetTextById(5022), itemsInfo.name, itemsNumber + "");
                break;
        }
        preTypeData.preFailStr = string.Format(TextHandler.Instance.GetTextById(5023), itemsInfo.name, itemsNumber + "");
        return preTypeData;
    }
