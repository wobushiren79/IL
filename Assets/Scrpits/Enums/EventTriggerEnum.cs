...
public class EventTriggerEnumTools
{
    ...
    public static List<EventTriggerBean> GetListTriggerData(string data)
    {
        ...
        foreach (string itemData in listData)
        {
            ...
            EventTriggerEnum triggerType = itemListData[0].GetEnum<EventTriggerEnum>();
    ...
    {
        long[] favorabilityData = triggerData.triggerData.SplitForArrayLong(',');
    ...
    {
        long[] idsData = triggerData.triggerData.SplitForArrayLong(',');
