    ...
    MiniGameAccountEjectorCpt.ICallBack
{
    ...
    public override void StartGame()
    {
        ...
        //打开游戏UI
        UIMiniGameAccount uiMiniGameAccount = UIHandler.Instance.OpenUIAndCloseOther<UIMiniGameAccount>();
    ...
    {
        UIMiniGameAccount uiMiniGameAccount = (UIMiniGameAccount)UIHandler.Instance.GetOpenUI();
        while (true)
        {
            //设置游戏UI时间
