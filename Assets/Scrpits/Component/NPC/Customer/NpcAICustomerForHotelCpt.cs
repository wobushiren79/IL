...
public class NpcAICustomerForHotelCpt : BaseNpcAI
{
    ...
    public virtual CustomerHotelIntentEnum GetCustomerHotelStatus(out string intentStr)
    {
        ...
        switch (customerHotelIntent)
        {
            ...
            case CustomerHotelIntentEnum.GoToBed:
                intentStr = TextHandler.Instance.GetTextById(162);
                break;
            case CustomerHotelIntentEnum.Sleep:
                intentStr = TextHandler.Instance.GetTextById(164);
                break;
            case CustomerHotelIntentEnum.GoToStairsForSecond:
                intentStr = TextHandler.Instance.GetTextById(163);
                break;
        ...
        if (characterMoveCpt.IsAutoMoveStop())
        {
            ...
            if (InnHandler.Instance.GetInnStatus() == InnHandler.InnStatusEnum.Open)
            {
                ...
                if (buildBedCpt != null)
                {
                    ...
                    characterShoutCpt.Shout(TextHandler.Instance.GetTextById(13401));
                }
                else
                {
                    SetIntent(CustomerHotelIntentEnum.Leave);
    ...
    public void AddWaitIcon()
    {
        ...
        Sprite spWaitIcon = IconHandler.Instance.GetIconSpriteByName("worker_waiter_bed_pro_2");
        //Sprite spWaitIcon = IconHandler.Instance.GetIconSpriteByName("time_wait_1_0");
    ...
    public void AddPayIcon()
    {
        ...
        Sprite spPayIcon = IconHandler.Instance.GetIconSpriteByName("money_1");
