...
public class UIMainCreateAttributesChange : BaseUIView, NumberChangeView.ICallBack
{
    ...
    public void SetTitle()
    {
        if (tvTitle != null)
        {
            tvTitle.text = string.Format(TextHandler.Instance.GetTextById(77), " "+ pointsForResidue );
        }
    }
