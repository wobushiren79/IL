...
public class UIGameStatisticsForInn : UIGameStatisticsDetailsBase<UIGameStatistics>
{
    ...
    {
        Sprite spIcon_1 = IconHandler.Instance.GetIconSpriteByName("money_1");
        CreateTextItem(spIcon_1, Color.white, TextHandler.Instance.GetTextById(340), moneyFoodS + TextHandler.Instance.GetTextById(18));
        Sprite spIcon_2 = IconHandler.Instance.GetIconSpriteByName("money_1");
        CreateTextItem(spIcon_2, Color.white, TextHandler.Instance.GetTextById(345), moneyHotelS + TextHandler.Instance.GetTextById(18));
    }
    ...
    {
        Sprite spIcon_1 = IconHandler.Instance.GetIconSpriteByName("ach_ordernumber_1");
        CreateTextItem(spIcon_1, Color.white, TextHandler.Instance.GetTextById(341), orderFoodNumber + "");
        Sprite spIcon_2 = IconHandler.Instance.GetIconSpriteByName("worker_waiter_bed_pro_2");
        CreateTextItem(spIcon_2, Color.white, TextHandler.Instance.GetTextById(346), orderHotelNumber + "");
    }
    ...
    {
        Sprite spIcon_1 = IconHandler.Instance.GetIconSpriteByName("team_2");
        CreateTextItem(spIcon_1, Color.red, TextHandler.Instance.GetTextById(301), numberForCustomerFood + TextHandler.Instance.GetTextById(82));
        Sprite spIcon_2 = IconHandler.Instance.GetIconSpriteByName("team_2");
        CreateTextItem(spIcon_2, Color.red, TextHandler.Instance.GetTextById(338), numberForCustomerFoodComplete + TextHandler.Instance.GetTextById(82));
        Sprite spIcon_3 = IconHandler.Instance.GetIconSpriteByName("worker_waiter_bed_pro_2");
        CreateTextItem(spIcon_3, Color.white, TextHandler.Instance.GetTextById(342), numberForCustomerHotel + TextHandler.Instance.GetTextById(82));
        Sprite spIcon_4 = IconHandler.Instance.GetIconSpriteByName("worker_waiter_bed_pro_2");
        CreateTextItem(spIcon_4, Color.white, TextHandler.Instance.GetTextById(343), numberForCustomerHotelComplete + TextHandler.Instance.GetTextById(82));
    }
    ...
    public void AddItemForOwnMoney(MoneyEnum moneyType,  long money)
    {
        ...
        switch(moneyType)
        {
            case MoneyEnum.L:
                iconKey = "money_3";
                contentStr = TextHandler.Instance.GetTextById(305);
                break;
            case MoneyEnum.M:
                iconKey = "money_2";
                contentStr = TextHandler.Instance.GetTextById(304);
                break;
            case MoneyEnum.S:
                iconKey = "money_1";
                contentStr = TextHandler.Instance.GetTextById(303);
                break;
        }
        Sprite spIcon = IconHandler.Instance.GetIconSpriteByName(iconKey);
        CreateTextItem(spIcon, contentStr, money + "");
        //CreateMoneyItem(spIconL, TextHandler.Instance.GetTextById(305), moneyL, moneyM, moneyS);
    }
    ...
    public void AddItemForPayMoney(MoneyEnum moneyType, long money)
    {
        ...
        switch (moneyType)
        {
            case MoneyEnum.L:
                iconKey = "money_3";
                contentStr = TextHandler.Instance.GetTextById(363);
                break;
            case MoneyEnum.M:
                iconKey = "money_2";
                contentStr = TextHandler.Instance.GetTextById(362);
                break;
            case MoneyEnum.S:
                iconKey = "money_1";
                contentStr = TextHandler.Instance.GetTextById(361);
                break;
        }
        Sprite spIcon = IconHandler.Instance.GetIconSpriteByName(iconKey);
    ...
    {
        Sprite spIcon = IconHandler.Instance.GetIconSpriteByName("guild_coin_2");
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(306), number + "");
    }
    ...
    public void AddItemForOwnTrophy(TrophyTypeEnum trophyType,long number)
    {
        ...
        switch (trophyType)
        {
            case TrophyTypeEnum.Elementary:
                iconKey = "trophy_1_0";
                contentStr = TextHandler.Instance.GetTextById(307);
                break;
            case TrophyTypeEnum.Intermediate:
                iconKey = "trophy_1_1";
                contentStr = TextHandler.Instance.GetTextById(308);
                break;
            case TrophyTypeEnum.Advanced:
                iconKey = "trophy_1_2";
                contentStr = TextHandler.Instance.GetTextById(309);
                break;
            case TrophyTypeEnum.Legendary:
                iconKey = "trophy_1_3";
                contentStr = TextHandler.Instance.GetTextById(310);
                break;
        }
        Sprite spIcon = IconHandler.Instance.GetIconSpriteByName(iconKey);
    ...
    public void AddItemForPraiseNumber(PraiseTypeEnum praiseType,long number)
    {
        ...
        Sprite spIcon = IconHandler.Instance.GetIconSpriteByName(iconKey);
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(336), number + "");
    }
