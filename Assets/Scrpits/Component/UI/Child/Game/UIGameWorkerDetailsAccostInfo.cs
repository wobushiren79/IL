...
public class UIGameWorkerDetailsAccostInfo : UIGameStatisticsDetailsBase<UIGameWorkerDetails>
{
    ...
    public void AddAccostSolicitTotalNumber(long number)
    {
        ...
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(323), number + "");
    }
    ...
    {
        Sprite spIcon = GetSpriteByName("worker_accost_pro_0");
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(324), number + "");
    }
    ...
    {
        Sprite spIcon = GetSpriteByName("worker_accost_pro_0");
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(325), number + "");
    }
    ...
    public void AddAccostGuideNumber(long number)
    {
        ...
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(347), number + "");
    }
}