...
public class BaseControl : BaseMonoBehaviour
{
    ...
    public void SetCameraPosition(Vector2 position)
    {
        ...
        {
            CameraHandler.Instance.manager.camera2D.transform.position = new Vector3(position.x, position.y, CameraHandler.Instance.manager.camera2D.transform.position.z);
        }
;
    }
