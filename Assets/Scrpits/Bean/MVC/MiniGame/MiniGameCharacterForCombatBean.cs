...
public class MiniGameCharacterForCombatBean : MiniGameCharacterBean
{
    ...
    public int GetTotalDef(int damage)
    {
        ...
        {
            damage = BufferTypeEnumTools.GetTotalDef(characterData, itemData.listEffectTypeData, damage);
        }
        return damage;
    }
    ...
    public void GetTotalAttributes(CharacterAttributesBean  addAttributesData)
    {
        foreach (MiniGameCombatEffectBean itemData in listCombatEffect)
        {
            BufferTypeEnumTools.GetTotalAttributes(itemData.listEffectTypeData, addAttributesData);
        }
    }
