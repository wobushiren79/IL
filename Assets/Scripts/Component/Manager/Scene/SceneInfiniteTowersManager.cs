    ...
    public List<CharacterBean> GetCharacterDataByInfiniteTowersLayer(long layer)
    {
        ...
        if (layer % 10 == 0)
        {
            ...
            switch (layer)
            {
                ...
                case 20:
                case 30:
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersBossForLevel1, out bossTeamMembers);
                    //bossTeamMembers = "7400011";
                    break;
                case 40:
                case 50:
                case 60:
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersBossForLevel2, out bossTeamMembers);
                    break;
                case 70:
                case 80:
                case 90:
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersBossForLevel3, out bossTeamMembers);
                    break;
                case 100:
                case 110:
                case 120:
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersBossForLevel4, out bossTeamMembers);
                    break;
                default:
         
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersBossForLevel1, out string level1);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersBossForLevel2, out string level2);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersBossForLevel2, out string level3);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersBossForLevel2, out string level4);
