...
public class NpcAIWorkerForAccost : NpcAIWokerFoBaseCpt
{
    ...
    public void SetIntentForGoToStairsForFirst()
    {
        ...
        if (buildStairs == null)
        {
            npcAIWorker.SetShout(TextHandler.Instance.GetTextById(13402));
            orderForHotel.customer.ChangeMood(-99999);
            SetIntent(AccostIntentEnum.Idle);
            return;
        }
        npcAIWorker.SetShout(TextHandler.Instance.GetTextById(13404));
    ...
    public void SetIntentForGoToBed()
    {
        ...
        {
            //不能到达
            npcAIWorker.SetShout(TextHandler.Instance.GetTextById(13405));
