...
public class UIGameWorkerDetailsWaiterInfo : UIGameStatisticsDetailsBase<UIGameWorkerDetails>
{
    ...
    public void AddSendNumber(long number)
    {
        ...
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(313), number + "");
    }
    ...
    public void AddCleanTableNumber(long number)
    {
        ...
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(314), number + "");
    }
    ...
    public void AddCleanTime(float time)
    {
        ...
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(315), time + TextHandler.Instance.GetTextById(38));
    }
    ...
    public void AddCleanBedNumber(float number)
    {
        ...
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(348), number + "");
    }
