...
public class UIGameWorkerDetailsAccountantInfo : UIGameStatisticsDetailsBase<UIGameWorkerDetails>
{
    ...
    public void AddTotalData(long totalNumber, long totalMoneyL, long totalMoneyM, long totalMoneyS)
    {
        ...
        CreateTextItem(spIcon1, TextHandler.Instance.GetTextById(316), totalNumber + "");
        Sprite spIcon2 = GetSpriteByName("money_1");
        CreateMoneyItem(spIcon2, TextHandler.Instance.GetTextById(317), totalMoneyL, totalMoneyM, totalMoneyS);
    }
    ...
    {
        Sprite spIcon1 = GetSpriteByName("worker_accounting_pro_0");
        CreateTextItem(spIcon1, TextHandler.Instance.GetTextById(318), Color.green, successNumber + "");
        Sprite spIcon2 = GetSpriteByName("money_1");
        CreateMoneyItem(spIcon2, TextHandler.Instance.GetTextById(319), Color.green, moreMoneyL, moreMoneyM, moreMoneyS);
    }
    ...
    {
        Sprite spIcon1 = GetSpriteByName("worker_accounting_pro_0");
        CreateTextItem(spIcon1, TextHandler.Instance.GetTextById(320), Color.red, failNumber + "");
        Sprite spIcon2 = GetSpriteByName("money_1");
        CreateMoneyItem(spIcon2, TextHandler.Instance.GetTextById(321), Color.red, loseMoneyL, loseMoneyM, loseMoneyS);
    }
    ...
    public void AddAccountingTime(float time)
    {
        ...
        CreateTextItem(spIcon, TextHandler.Instance.GetTextById(322), time + TextHandler.Instance.GetTextById(38));
    }
}