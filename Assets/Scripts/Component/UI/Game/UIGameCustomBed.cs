...
public class UIGameCustomBed : UIBaseOne, IRadioGroupCallBack
{
    ...
    public void SetBedText(BuildBedBean buildBedData)
    {
        ...
        if (tvBedBase != null && bedBaseData != null)
            tvBedBase.text = bedBaseData.name_language;
        if (tvBedBar != null && bedBarData != null)
            tvBedBar.text = bedBarData.name_language;
        if (tvBedSheets != null && bedSheetsData != null)
            tvBedSheets.text = bedSheetsData.name_language;
        if (tvBedPillow != null && bedPillowData != null)
            tvBedPillow.text = bedPillowData.name_language;
    }
    ...
    {
        UIHandler.Instance.OpenUIAndCloseOther<UITownCarpenter>();
    }
    ...
    {
        BuildItemTypeEnum buildItemType = rbview.name.GetEnum<BuildItemTypeEnum>();
