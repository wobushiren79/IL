...

{
    ...
    public void InitData()
    {
        ...
        //初始化帽子
        GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.HatForLevel0, out string hatListStr);
        ...
        //初始化衣服
        GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.ClothesForLevel0, out string clothesListStr);
        ...
        //初始化鞋子
        GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.ShoesForLevel0, out string shoesListStr);
