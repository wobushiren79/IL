...
public class RevenueCartogramBarForItem : CartogramBarForItem
{
    ...
    {
        data += TextHandler.Instance.GetTextById(31);
        base.SetHData(data);
    }
    ...
    public override void SetVData(string data)
    {
        ...
        {
            data = TextHandler.Instance.GetTextById(20);
        }
        else
        {
            data = "";
            ...
            {
                data += (cartogramData.value_1 + TextHandler.Instance.GetTextById(16));
            }
            if (cartogramData.value_2 != 0)
            {
                data += (cartogramData.value_2 + TextHandler.Instance.GetTextById(17));
            }
            if (cartogramData.value_3 != 0)
            {
                data += (cartogramData.value_3 + TextHandler.Instance.GetTextById(18));
            }
            if (cartogramData.value_1 == 0 && cartogramData.value_2 == 0 && cartogramData.value_3 == 0)
            {
                data += TextHandler.Instance.GetTextById(47);
            }
        }
        base.SetVData(data);
    }
