...
public class ItemTownGoodsMarketCpt : ItemGameBaseCpt
{
    ...
    public void SetData(StoreInfoBean goodsData, Sprite spIcon)
    {
        ...
        SetName(goodsData.name_language);
        SetIcon(spIcon);
        SetNumber(1);
    ...
    public void BuyGoods()
    {
        ...
        dialogData.content = string.Format(TextHandler.Instance.GetTextById(3009), tvPirce.text, buyNumber, goodsData.name_language);
    ...
    public void Submit(DialogView dialogView, DialogBean dialogBean)
    {
        ...
        if (buyNumber <= 0)
        {
            UIHandler.Instance.ToastHint<ToastView>(TextHandler.Instance.GetTextById(1017));
            return;
        }
        ...
        {
            UIHandler.Instance.ToastHint<ToastView>(TextHandler.Instance.GetTextById(1026));
            return;
        }
        ...
        RreshData();
        UIHandler.Instance.ToastHint<ToastView>(ivIcon.sprite, string.Format(TextHandler.Instance.GetTextById(1018), buyNumber, goodsData.name_language, tvPirce.text));
    }
