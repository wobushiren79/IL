...
public class RewardTypeEnumTools : DataTools
{
    ...
    public static RewardTypeBean GetRewardDetails(RewardTypeBean data)
    {
        switch (data.dataType)
        {
            case RewardTypeEnum.AddWorkerNumber:
                ...
                data.rewardDescribe = string.Format(TextHandler.Instance.GetTextById(6001), data.data);
            ...
            case RewardTypeEnum.AddWorker:
                ...
                data.rewardDescribe = string.Format(TextHandler.Instance.GetTextById(6011), data.workerCharacterData.baseInfo.name);
                break;
            ...
            case RewardTypeEnum.AddGuildCoin:
                ...
                data.rewardDescribe = string.Format(TextHandler.Instance.GetTextById(6005), data.data);
                data.rewardNumber = int.Parse(data.data);
                break;
    ...
    protected static RewardTypeBean GetRewardDetailsForWorkerExp(RewardTypeBean rewardTypeData)
    {
        ...
        switch (rewardTypeData.dataType)
        {
            case RewardTypeEnum.AddChefExp:
                ...
                rewardDescribe = WorkerEnumTools.GetWorkerName(WorkerEnum.Chef) + string.Format(TextHandler.Instance.GetTextById(6021), rewardTypeData.data);
                break;
            case RewardTypeEnum.AddWaiterExp:
                spriteIcon = WorkerEnumTools.GetWorkerSprite(WorkerEnum.Waiter);
                rewardDescribe = WorkerEnumTools.GetWorkerName(WorkerEnum.Waiter) + string.Format(TextHandler.Instance.GetTextById(6021), rewardTypeData.data);
                break;
            case RewardTypeEnum.AddAccountantExp:
                spriteIcon = WorkerEnumTools.GetWorkerSprite(WorkerEnum.Accountant);
                rewardDescribe = WorkerEnumTools.GetWorkerName(WorkerEnum.Accountant) + string.Format(TextHandler.Instance.GetTextById(6021), rewardTypeData.data);
                break;
            case RewardTypeEnum.AddAccostExp:
                spriteIcon = WorkerEnumTools.GetWorkerSprite(WorkerEnum.Accost);
                rewardDescribe = WorkerEnumTools.GetWorkerName(WorkerEnum.Accost) + string.Format(TextHandler.Instance.GetTextById(6021), rewardTypeData.data);
                break;
            case RewardTypeEnum.AddBeaterExp:
                spriteIcon = WorkerEnumTools.GetWorkerSprite(WorkerEnum.Beater);
                rewardDescribe = WorkerEnumTools.GetWorkerName(WorkerEnum.Beater) + string.Format(TextHandler.Instance.GetTextById(6021), rewardTypeData.data);
                break;
        }
    ...
    private static RewardTypeBean GetRewardDetailsForAddTrophy(RewardTypeBean rewardTypeData)
    {
        ...
        switch (rewardTypeData.dataType)
        {
            case RewardTypeEnum.AddArenaTrophyElementary:
                iconKey = "trophy_1_0";
                rewardDescribe = string.Format(TextHandler.Instance.GetTextById(6006), listData[0] + "");
                break;
            case RewardTypeEnum.AddArenaTrophyIntermediate:
                iconKey = "trophy_1_1";
                rewardDescribe = string.Format(TextHandler.Instance.GetTextById(6007), listData[0] + "");
                break;
            case RewardTypeEnum.AddArenaTrophyAdvanced:
                iconKey = "trophy_1_2";
                rewardDescribe = string.Format(TextHandler.Instance.GetTextById(6008), listData[0] + "");
                break;
            case RewardTypeEnum.AddArenaTrophyLegendary:
                iconKey = "trophy_1_3";
                rewardDescribe = string.Format(TextHandler.Instance.GetTextById(6009), listData[0] + "");
                break;
        }
    ...
    private static RewardTypeBean GetRewardDetailsForAddMoney(RewardTypeBean rewardTypeData)
    {
        ...
        switch (rewardTypeData.dataType)
        {
            case RewardTypeEnum.AddMoneyL:
                iconKey = "money_3";
                rewardDescribe = string.Format(TextHandler.Instance.GetTextById(6002), rewardTypeData.data);
                break;
            case RewardTypeEnum.AddMoneyM:
                iconKey = "money_2";
                rewardDescribe = string.Format(TextHandler.Instance.GetTextById(6003), rewardTypeData.data);
                break;
            case RewardTypeEnum.AddMoneyS:
                iconKey = "money_1";
                rewardDescribe = string.Format(TextHandler.Instance.GetTextById(6004), rewardTypeData.data);
                break;
        }
        rewardTypeData.spRewardIcon = IconHandler.Instance.GetIconSpriteByName(iconKey);
        rewardTypeData.rewardDescribe = rewardDescribe;
    ...
    private static RewardTypeBean GetRewardDetailsForBuildItems(RewardTypeBean data)
    {
        ...
        data.rewardDescribe = buildItemInfo.name_language;
    ...
    private static RewardTypeBean GetRewardDetailsForItems(RewardTypeBean data)
    {
        ...
        data.rewardDescribe = itemsInfo.name_language;
    ...
    {
        data.rewardDescribe = TextHandler.Instance.GetTextById(6101);
        ...
        foreach (var itemData in listRewardData)
        {
            ...
            switch (dataType)
            {
                ...
                case RewardTypeEnum.AddWorker:
                    ...
                    UIHandler.Instance.ToastHint<ToastView>(string.Format(TextHandler.Instance.GetTextById(6011), itemData.workerCharacterData.baseInfo.name));
                    break;
                case RewardTypeEnum.AddGuildCoin:
                    long addGuildCoin = itemData.rewardNumber;
                    gameData.AddGuildCoin(addGuildCoin);
                    UIHandler.Instance.ToastHint<ToastView>(itemData.spRewardIcon, string.Format(TextHandler.Instance.GetTextById(6099), itemData.rewardDescribe));
                    break;
                case RewardTypeEnum.AddMoneyL:
                    long addMoneyL = itemData.rewardNumber;
                    gameData.AddMoney(addMoneyL, 0, 0);
                    UIHandler.Instance.ToastHint<ToastView>(itemData.spRewardIcon, string.Format(TextHandler.Instance.GetTextById(6014), addMoneyL + ""));
                    break;
                case RewardTypeEnum.AddMoneyM:
                    long addMoneyM = itemData.rewardNumber;
                    gameData.AddMoney(0, addMoneyM, 0);
                    UIHandler.Instance.ToastHint<ToastView>(itemData.spRewardIcon, string.Format(TextHandler.Instance.GetTextById(6013), addMoneyM + ""));
                    break;
                case RewardTypeEnum.AddMoneyS:
                    long addMoneyS = itemData.rewardNumber;
                    gameData.AddMoney(0, 0, addMoneyS);
                    UIHandler.Instance.ToastHint<ToastView>(itemData.spRewardIcon, string.Format(TextHandler.Instance.GetTextById(6012), addMoneyS + ""));
                    break;
                case RewardTypeEnum.AddArenaTrophyElementary:
                    long addTrophy1 = itemData.rewardNumber;
                    gameData.AddArenaTrophy(addTrophy1, 0, 0, 0, itemData.isRecord);
                    UIHandler.Instance.ToastHint<ToastView>(itemData.spRewardIcon, string.Format(TextHandler.Instance.GetTextById(6099), string.Format(TextHandler.Instance.GetTextById(6006), addTrophy1 + "")));
                    break;
                case RewardTypeEnum.AddArenaTrophyIntermediate:
                    long addTrophy2 = itemData.rewardNumber;
                    gameData.AddArenaTrophy(0, addTrophy2, 0, 0, itemData.isRecord);
                    UIHandler.Instance.ToastHint<ToastView>(itemData.spRewardIcon, string.Format(TextHandler.Instance.GetTextById(6099), string.Format(TextHandler.Instance.GetTextById(6007), addTrophy2 + "")));
                    break;
                case RewardTypeEnum.AddArenaTrophyAdvanced:
                    long addTrophy3 = itemData.rewardNumber;
                    gameData.AddArenaTrophy(0, 0, addTrophy3, 0, itemData.isRecord);
                    UIHandler.Instance.ToastHint<ToastView>(itemData.spRewardIcon, string.Format(TextHandler.Instance.GetTextById(6099), string.Format(TextHandler.Instance.GetTextById(6008), addTrophy3 + "")));
                    break;
                case RewardTypeEnum.AddArenaTrophyLegendary:
                    long addTrophy4 = itemData.rewardNumber;
                    gameData.AddArenaTrophy(0, 0, 0, addTrophy4, itemData.isRecord);
                    UIHandler.Instance.ToastHint<ToastView>(itemData.spRewardIcon, string.Format(TextHandler.Instance.GetTextById(6099), string.Format(TextHandler.Instance.GetTextById(6009), addTrophy4 + "")));
                    break;
                case RewardTypeEnum.AddItems:
                case RewardTypeEnum.RandomAddItems:
    ...
    public static List<RewardTypeBean> GetRewardItemsForInfiniteTowers(List<CharacterBean> listEnemyData, int layer, int totalLucky, bool isSend)
    {
        ...
        if (layer % 10 == 0)
        {
            ...
            switch (layer)
            {
                ...
                case 20:
                case 30:
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersNormalRewardForLevel1, out rewardForNormalStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersRareRewardForLevel1, out rewardForRareStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersNormalBuildRewardForLevel1, out rewardForNormalBuildStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersRareBuildRewardForLevel1, out rewardForRareBuildStr);
                    break;
                case 40:
                case 50:
                case 60:
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersNormalRewardForLevel2, out rewardForNormalStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersRareRewardForLevel2, out rewardForRareStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersNormalBuildRewardForLevel2, out rewardForNormalBuildStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersRareBuildRewardForLevel2, out rewardForRareBuildStr);
                    break;
                case 70:
                case 80:
                case 90:
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersNormalRewardForLevel3, out rewardForNormalStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersRareRewardForLevel3, out rewardForRareStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersNormalBuildRewardForLevel3, out rewardForNormalBuildStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersRareBuildRewardForLevel3, out rewardForRareBuildStr);
                    break;
                default:
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersNormalRewardForLevel4, out rewardForNormalStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersRareRewardForLevel4, out rewardForRareStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersNormalBuildRewardForLevel4, out rewardForNormalBuildStr);
                    GameCommonInfo.baseDataService.GetBaseData(BaseDataTypeEnum.InfiniteTowersRareBuildRewardForLevel4, out rewardForRareBuildStr);
                    break;
            }
