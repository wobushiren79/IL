...
public class PreTypeEnumTools : DataTools
{
        ...
        PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        {
            case PreTypeEnum.HaveItems:
                preTypeData.preDescribe = string.Format(TextHandler.Instance.GetTextById(5021), itemsInfo.name_language, itemsNumber + "");
                break;
            case PreTypeEnum.PayItems:
                preTypeData.preDescribe = string.Format(TextHandler.Instance.GetTextById(5022), itemsInfo.name_language, itemsNumber + "");
                break;
        }
        preTypeData.preFailStr = string.Format(TextHandler.Instance.GetTextById(5023), itemsInfo.name_language, itemsNumber + "");
        return preTypeData;
    }
    ...
    private static PreTypeBean GetPreDetailsForPay(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        switch (preTypeData.dataType)
        {
            case PreTypeEnum.PayMoneyL:
                ...
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5001);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1005);
                iconKey = "money_3";
                break;
            case PreTypeEnum.PayMoneyM:
                have = gameData.moneyM;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5002);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1005);
                iconKey = "money_2";
                break;
            case PreTypeEnum.PayMoneyS:
                have = gameData.moneyS;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5003);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1005);
                iconKey = "money_1";
                break;
            case PreTypeEnum.PayGuildCoin:
                have = gameData.guildCoin;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5201);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1012);
                iconKey = "guild_coin_2";
                break;
            case PreTypeEnum.PayTrophyElementary:
                have = gameData.trophyElementary;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5203);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1021);
                iconKey = "trophy_1_0";
                break;
            case PreTypeEnum.PayTrophyIntermediate:
                have = gameData.trophyIntermediate;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5204);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1021);
                iconKey = "trophy_1_1";
                break;
            case PreTypeEnum.PayTrophyAdvanced:
                have = gameData.trophyAdvanced;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5205);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1021);
                iconKey = "trophy_1_2";
                break;
            case PreTypeEnum.PayTrophyLegendary:
                have = gameData.trophyLegendary;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5206);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1021);
                iconKey = "trophy_1_3";
                break;
        }
    ...
    private static PreTypeBean GetPreDetailsForHave(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        switch (preTypeData.dataType)
        {
            case PreTypeEnum.HaveMoneyL:
                own = gameData.moneyL;
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1005);
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5004);
                iconKey = "money_3";
                break;
            case PreTypeEnum.HaveMoneyM:
                own = gameData.moneyM;
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1005);
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5005);
                iconKey = "money_2";
                break;
            case PreTypeEnum.HaveMoneyS:
                own = gameData.moneyS;
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1005);
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5006);
                iconKey = "money_1";
                break;
            case PreTypeEnum.PayGuildCoin:
                own = gameData.guildCoin;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5202);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1012);
                iconKey = "guild_coin_2";
                break;
            case PreTypeEnum.PayTrophyElementary:
                own = gameData.trophyElementary;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5207);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1021);
                iconKey = "trophy_1_0";
                break;
            case PreTypeEnum.PayTrophyIntermediate:
                own = gameData.trophyIntermediate;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5208);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1021);
                iconKey = "trophy_1_1";
                break;
            case PreTypeEnum.PayTrophyAdvanced:
                own = gameData.trophyAdvanced;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5209);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1021);
                iconKey = "trophy_1_2";
                break;
            case PreTypeEnum.PayTrophyLegendary:
                own = gameData.trophyLegendary;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5210);
                preTypeData.preFailStr = TextHandler.Instance.GetTextById(1021);
                iconKey = "trophy_1_3";
                break;
        }
    ...
    private static PreTypeBean GetPreDetailsForPayIng(PreTypeBean preTypeData, GameDataBean gameData)
    {
        ...
        preTypeData.preDescribe = string.Format(TextHandler.Instance.GetTextById(5031), ingName, dataIng + "");
        preTypeData.preFailStr = string.Format(TextHandler.Instance.GetTextById(5023), ingName, dataIng + "");
        return preTypeData;
    }
    ...
    private static PreTypeBean GetPreDetailsForOrderNumber(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        switch (preTypeData.dataType)
        {
            case PreTypeEnum.OrderNumberForTotal:
                ...
                preDescribeTitle = TextHandler.Instance.GetTextById(5041);
                preFailTitle = TextHandler.Instance.GetTextById(5042);
            ...
            case PreTypeEnum.OrderNumberForHotelTotal:
                ...
                preDescribeTitle = TextHandler.Instance.GetTextById(5043);
                preFailTitle = TextHandler.Instance.GetTextById(5044);
    ...
    private static PreTypeBean GetPreDetailsForGetMoney(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        switch (preTypeData.dataType)
        {
            case PreTypeEnum.GetMoneyL:
                ...
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5007);
                iconKey = "money_3";
                break;
            case PreTypeEnum.GetMoneyM:
                haveMoney = userAchievement.ownMoneyM;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5008);
                iconKey = "money_2";
                break;
            case PreTypeEnum.GetMoneyS:
                haveMoney = userAchievement.ownMoneyS;
                preTypeData.preDescribe = TextHandler.Instance.GetTextById(5009);
                iconKey = "money_1";
                break;
        }
        ...
        preTypeData.preFailStr = TextHandler.Instance.GetTextById(1024);
        return preTypeData;
    }
    ...
    private static PreTypeBean GetPreDetailsForInnPraiseNumber(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        preTypeData.preFailStr = TextHandler.Instance.GetTextById(5057);
        return preTypeData;
    }
    ...
    private static PreTypeBean GetPreDetailsForMenuNumber(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        switch (preTypeData.dataType)
        {
            case PreTypeEnum.MenuNumber:
                ...
                content = TextHandler.Instance.GetTextById(5061);
                contentFail = TextHandler.Instance.GetTextById(5062);
                break;
            case PreTypeEnum.MenuLevelStarNumber:
                menuNumber = gameData.GetMenuNumberByLevel(LevelTypeEnum.Star);
                content = TextHandler.Instance.GetTextById(5063);
                contentFail = TextHandler.Instance.GetTextById(5064);
    ...
    private static PreTypeBean GetPreDetailsForBedNumber(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        switch (preTypeData.dataType)
        {
            case PreTypeEnum.BedNumber:
                ...
                content = TextHandler.Instance.GetTextById(5065);
                contentFail = TextHandler.Instance.GetTextById(5066);
                break;
            case PreTypeEnum.BedLevelStarNumber:
                bedNumber = gameData.GetBedNumberByLevel(LevelTypeEnum.Star);
                content = TextHandler.Instance.GetTextById(5067);
                contentFail = TextHandler.Instance.GetTextById(5068);
                levelStr = LevelTypeEnumTools.GetLevelStr(LevelTypeEnum.Star);
                break;
            case PreTypeEnum.BedLevelMoonNumber:
    ...
    private static PreTypeBean GetPreDetailsForSellMenuNumber(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        preTypeData.spPreIcon = spIcon;
        preTypeData.preDescribe = string.Format(TextHandler.Instance.GetTextById(5071), preProStr + "");
        preTypeData.preFailStr = TextHandler.Instance.GetTextById(5072);
        return preTypeData;
    }
    ...
    private static PreTypeBean GetPreDetailsForHaveMenu(PreTypeBean preTypeData, GameDataBean gameData)
    {
        ...
        foreach (long menuId in menuIds)
        {
            ...
            foodListStr += ("《" + menuInfo.name_language + "》");
            bool hasMenu = gameData.CheckHasMenu(menuId);
            if (!hasMenu)
            {
                noFoodStr = "《" + menuInfo.name_language + "》";
                hasAllMenu = false;
            }
        }
        ...
        preTypeData.preDescribe = string.Format(TextHandler.Instance.GetTextById(5073), foodListStr + "");
        preTypeData.preFailStr = string.Format(TextHandler.Instance.GetTextById(5074), noFoodStr + "");
        return preTypeData;
    ...
    private static PreTypeBean GetPreDetailsForWorker(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        foreach (CharacterBean itemWorkerData in listWorker)
        {
            ...
            {
                case PreTypeEnum.WorkerForCookFoodNumber:
                    preDesStr = TextHandler.Instance.GetTextById(311);
                ...
                case PreTypeEnum.WorkerForAccountantFailNumber:
                    ...
                    {
                        preDesStr = TextHandler.Instance.GetTextById(318);
                    ...
                    {
                        preDesStr = TextHandler.Instance.GetTextById(320);
                ...
                case PreTypeEnum.WorkerForAccostGuideNumber:
                    ...
                    {
                        preDesStr = TextHandler.Instance.GetTextById(324);
                    ...
                    {
                        preDesStr = TextHandler.Instance.GetTextById(325);
                    ...
                    {
                        preDesStr = TextHandler.Instance.GetTextById(347);
        ...
        preTypeData.preFailStr = TextHandler.Instance.GetTextById(5081);
        return preTypeData;
    }
    ...
    private static PreTypeBean GetPreDetailsForInnPraise(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        {
            case PreTypeEnum.InnPraise:
                preDesStr = TextHandler.Instance.GetTextById(5091);
        ...
        preTypeData.spPreIcon = spIcon;
        preTypeData.preDescribe = preDesStr + preProStr;
        preTypeData.preFailStr = TextHandler.Instance.GetTextById(5092);
        return preTypeData;
    }
    ...
    private static PreTypeBean GetPreDetailsForInnAesthetics(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        {
            case PreTypeEnum.InnAesthetics:
                preDesStr = TextHandler.Instance.GetTextById(5101);
        ...
        preTypeData.spPreIcon = spIcon;
        preTypeData.preDescribe = preDesStr + preProStr;
        preTypeData.preFailStr = TextHandler.Instance.GetTextById(5102);
        return preTypeData;
    }
    ...
    protected static PreTypeBean GetPreDetailsForNpcFavorabilityLevel(GameDataBean gameData, PreTypeBean preData)
    {
        ...
        preData.preDescribe = string.Format(TextHandler.Instance.GetTextById(5221), characterData.baseInfo.name, npcFavorabilityLevel + "");
        preData.preFailStr = string.Format(TextHandler.Instance.GetTextById(5222), characterData.baseInfo.name, npcFavorabilityLevel + "");
        return preData;
    }
    /// <summary>
    /// 获取出现详情  NPC好感
    ...
    protected static PreTypeBean GetPreDetailsForInfiniteTowersMaxLayer(PreTypeBean preTypeData, GameDataBean gameData, bool isComplete)
    {
        ...
        string preProStr = string.Format(TextHandler.Instance.GetTextById(5111), maxLayer + "");
        string preDesStr = "";
        UserAchievementBean userAchievement = gameData.GetAchievementData();
        ...
        preTypeData.spPreIcon = spIcon;
        preTypeData.preDescribe = preDesStr + preProStr;
        preTypeData.preFailStr = TextHandler.Instance.GetTextById(5112);
        return preTypeData;
    }
