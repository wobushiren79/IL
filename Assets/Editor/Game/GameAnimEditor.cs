...
public class GameAnimEditor : AnimEditor
{
    ...
    public static void CreateAnimForMask()
    {
        ...
        {
            CreateAnimForTex(itemPicTex, "Assets/Anim/Animation/Equip/Mask", 10);
        }
    }
    ...
    public static void CreateAnimForHat()
    {
        ...
        foreach (Texture2D itemPicTex in listText)
        {
            CreateAnimForTex(itemPicTex, "Assets/Anim/Animation/Equip/Hat", 10);
        }
    }
    ...
    public static void CreateAnimForClothes()
    {
        ...
        foreach (Texture2D itemPicTex in listText)
        {
            CreateAnimForTex(itemPicTex, "Assets/Anim/Animation/Equip/Clothes", 10);
        }
    }
    ...
    public static void CreateAnimForShoes()
    {
        ...
        foreach (Texture2D itemPicTex in listText)
        {
            CreateAnimForTex(itemPicTex, "Assets/Anim/Animation/Equip/Shoes", 10);
        }
    }
    ...
    public static void CreateAnimForItems()
    {
        ...
        foreach (Texture2D itemPicTex in listText)
        {
            CreateAnimForTex(itemPicTex, "Assets/Anim/Animation/Equip/Items", 10);
        }
    }
}